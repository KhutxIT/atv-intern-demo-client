...
import alertActions from '../../store/action/alertAction';
...
class ProfilePictureForm extends PureComponent {
  ...
  handleUpload = (event) => {
    ...
    if (imgSrc) {
      ...
      const myFilename = `${username}.${imgSrcExt}`;
      // file to be uploaded
      ...
      <div>
        {imgSrc !== null ? (
          <div>
            ...
            <h1 className="straight-underlined" style={{ fontSize: '15px' }}>
...
export default connect(mapStateToProps)(ProfilePictureForm);
