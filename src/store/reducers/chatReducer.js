import { chatActionType } from "../action/chatAction";
...
export default function chat(
  ...
  switch (action.type) {
    ...
    case chatActionType.STOPPED_TYPING:
      if (state[action.roomId]) {
        return {
          ...state,
          [action.roomId]: {
    ...
    case chatActionType.CHANGE_ROOM:
      return {
        ...state,
        currentRoom: action.room,
        roomId: action.room._id,
      };
    case chatActionType.INIT_MESSAGE_ARRAY:
      if (!state[action.roomId]) {
        return {
          ...state,
          [action.roomId]: {
    ...
    case chatActionType.GET_ROOMS_REQUEST:
      return {
        ...state,
        roomsFetching: true,
      };
    case chatActionType.GET_ROOMS_SUCCESS:
      return {
        ...state,
        rooms: action.rooms,
        roomsFetching: false,
      };
    case chatActionType.ADD_NEW_ROOM:
      return {
        ...state,
        rooms: [action.room, ...state.rooms],
      };
    case chatActionType.GET_MESSAGES_INITIAL_REQUEST:
      return {
        ...state,
        [action.roomId]: {
          ...state[action.roomId],
    ...
    case chatActionType.GET_MESSAGES_REQUEST:
      return {
        ...state,
        [action.roomId]: {
          ...state[action.roomId],
    ...
    case chatActionType.GET_MESSAGES_SUCCESS:
    ...
    case chatActionType.SEND_MESSAGE_REQUEST:
    ...
    case chatActionType.SEND_MESSAGE_SUCCESS:
      if (state[action.message.roomId]) {
    ...
    case chatActionType.CHANGE_ACTIVITY_STATUS:
      return {
        ...state,
        rooms: state.rooms.map((room) => {
    ...
    case chatActionType.RECEIVE_READ_MESSAGES:
    ...
    case chatActionType.OPEN_CALLING_MODAL:
      return {
        ...state,
        callingModal: true,
      };
    case chatActionType.CLOSE_CALLING_MODAL:
      return {
        ...state,
        callingModal: false,
      };
    case chatActionType.OPEN_ANSWERING_MODAL:
      return {
        ...state,
        answeringModal: {
    ...
    case chatActionType.CLOSE_ANSWERING_MODAL:
      return {
        ...state,
        answeringModal: {
          ...state.answeringModal,
    ...
    case chatActionType.SEARCH_USERS:
      return {
        ...state,
